...
from stable_baselines3.common.type_aliases import Schedule, RNNStates, PyTorchObs
from stable_baselines3.common.utils import get_device, is_vectorized_observation, obs_as_tensor, zip_strict
...
class LSTMPolicy(ActorCriticPolicy):
    ...
    def _build_mlp_extractor(self) -> None:
        ...
        # print(self.mlp_extractor.forward_actor())
